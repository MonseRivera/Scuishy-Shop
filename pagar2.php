    ...
    if (isset($_SESSION['carrito']) && !empty($_SESSION['carrito'])) {
        ...
        if (isset($_POST['correo_destino']) && !empty($_POST['correo_destino'])) {
            ...
            try {
                ...
                $mail->SMTPAuth = true;
                $mail->Username = 'estefanyriverarivera15@gmail.com'; // Cambia esto a tu dirección de correo electrónico
                $mail->Password = 'lutuxndhdbpdjorj'; // Cambia esto a tu contraseña de correo electrónico
                $mail->SMTPSecure = 'tls'; // Puede ser 'tls' o 'ssl'
                $mail->Port = 587; // Puerto SMTP

                // Configura el remitente y el destinatario
                $correo_destino = filter_var($_POST['correo_destino'], FILTER_SANITIZE_EMAIL);
                $mail->setFrom('estefanyriverarivera15@gmail.com', 'Scuishy Shop'); // Remitente
